...
<!-- Mirrored from demo.lion-coders.com/html/listagram/db-messages.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Aug 2021 16:39:34 GMT -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="inbox-wrap">
                                <div class="act-title">
                                    <h5><i class="ion-android-mail"></i> Inbox</h5>
                                </div>
                                                ...
                                                <div class="au-message__item-inner">
                                                    <div class="au-message__item-text">
                                                        <div class="avatar-wrap">
                                                            <div class="avatar">
                                                                <img src="{{ asset('images/dashboard/avatar-01.jpg') }}" alt="John Smith">
                                                            </div>
                                                        </div>
                                                        <div class="text">
                                                ...
                                                <div class="au-message__item-inner">
                                                    <div class="au-message__item-text">
                                                        <div class="avatar-wrap online">
                                                            <div class="avatar">
                                                                <img src="{{ asset('images/dashboard/avatar-02.jpg') }}" alt="Nicholas Martinez">
                                                            </div>
                                                        </div>
                                                        <div class="text">
                                            ...
                                            <div class="au-message__item">
                                                <div class="au-message__item-inner">
                                                    <div class="au-message__item-text">
                                                        <div class="avatar-wrap online">
                                                            <div class="avatar">
                                                                <img src="{{ asset('images/dashboard/avatar-03.jpg') }}" alt="Michelle Sims">
                                                            </div>
                                                        </div>
                                                        <div class="text">
                                            ...
                                            <div class="au-message__item">
                                                <div class="au-message__item-inner">
                                                    <div class="au-message__item-text">
                                                        <div class="avatar-wrap">
                                                            <div class="avatar">
                                                                <img src="{{ asset('images/dashboard/avatar-04.jpg') }}" alt="Michelle Sims">
                                                            </div>
                                                        </div>
                                                        <div class="text">
                                                            <h5 class="name">Michelle Sims</h5>
                                            ...
                                            <div class="au-message__item js-load-item">
                                                <div class="au-message__item-inner">
                                                    <div class="au-message__item-text">
                                                        <div class="avatar-wrap online">
                                                            <div class="avatar">
                                                                <img src="{{ asset('images/dashboard/avatar-05.jpg') }}" alt="Michelle Sims">
                                                            </div>
                                                        </div>
                                                        <div class="text">
                                                            <h5 class="name">Michelle Sims</h5>
                                            ...
                                            <div class="au-chat-info">
                                                <div class="avatar-wrap online">
                                                    <div class="avatar avatar--small">
                                                        <img src="{{ asset('images/dashboard/avatar-02.jpg') }}" alt="John Smith">
                                                    </div>
                                                </div>
                                                <span class="nick">
                                                    <a href="#">John Smith</a>
                                                ...
                                                <div class="mess-btn mar-top-20">
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-12">
                                                            <a href="db-messages.html" class="float-left btn v3"><i class="ion-ios-arrow-back"></i> Back</a>
                                                        </div>
                                                        <div class="col-md-6 col-sm-12 order-md-2 order-first">
                                                            <a href="#" class="float-right sm-left btn v8"> Send message<i class="ion-android-send"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
...
<!-- Mirrored from demo.lion-coders.com/html/listagram/db-messages.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Aug 2021 16:40:48 GMT -->
</html>
